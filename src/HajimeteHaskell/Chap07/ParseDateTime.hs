module HajimeteHaskell.Chap07.ParseDateTime  where

import Data.List.Split (splitOn)

data YMD = YMD Int Int Int deriving (Show, Eq, Ord)
data HMS = HMS Int Int Int deriving (Show, Eq, Ord)

-- 日付形式 1987/07/23
parseYMD :: String -> Maybe YMDNothing
